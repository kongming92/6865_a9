...
def getOrientPaint(im, texture, imname):
    testOrientedPaint(im, texture, imname)
...
# runTests(vpd, bigBrush, "VPD")
# runTests(corgi, brush1, "Corgi")

# runTests(liz, longBrush, "LizTestLongBrush")
# runTests(china, longBrush, "ChinaTestLongBrush")
# runTests(roundIm, longBrush, "RoundImLongBrush")
# runTests(corgi, longBrush, "CorgiLongBrush")

zion = io.imread('zion.png')
getOrientPaint(zion, longBrush, "Zion")
